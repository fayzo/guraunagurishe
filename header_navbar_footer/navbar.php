    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex flex-row">
                <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<?php echo BASE_URL_LINK ;?>images/phone.png" alt=""></div>+250 787 384 312</div>
                <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<?php echo BASE_URL_LINK ;?>images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">irangiroltd@gmail.com</a></div>
                <div class="top_bar_content ml-auto">
                    <div class="top_bar_menu">
                        <ul class="standard_dropdown top_bar_dropdown">
                            ...
                            <li>
                                <a style="border: none;" href="javascript:void(0)" id="add_craft" data-craft="<?php echo $user_id; ?>" ><i class="fa fa-edit"></i> + Add Craft </a>
                            </li>
                            <li class="users_pro_li">
                                ...
                                <?php }else{ ?>
                                    <div class="top_bar_user">
                                        <div class="user_icon"><img src="<?php echo BASE_URL_LINK ;?>images/user.svg" alt=""></div>
                    ...
                    <div class="header_search_content">
                        <div class="header_search_form_container">
                            <form action="#" class="header_search_form clearfix">
                                ...
                                <button type="submit" class="header_search_button trans_300" value="Submit"><img src="<?php echo BASE_URL_LINK ;?>images/search.png" alt=""></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
                <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                    <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                        <div class="wishlist_icon"><img src="<?php echo BASE_URL_LINK ;?>images/heart.png" alt=""></div>
                    ...
                    <div class="cart">
                        <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                            <div class="cart_icon">
                                <img src="<?php echo BASE_URL_LINK ;?>images/cart.png" alt="">
            ...
            <div class="col">
                ...
                <div class="page_menu_content">
                    ...
                    <div class="menu_contact">
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="<?php echo BASE_URL_LINK ;?>images/phone_white.png" alt=""></div>+38 068 005 3570</div>
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="<?php echo BASE_URL_LINK ;?>images/mail_white.png" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
                    </div>
                </div>
            </div>
        </div>
